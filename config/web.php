...
return array (
  ...
  'json' => array (
    'title' => 'JSON在线解析,JSON格式化压缩,JSON转XML/Go/C#/Java' . $brand_suffix,
  ...
  'httpheader' => array (
    'title' => 'HTTP请求头对照表,HTTP Header大全,API接口Header查询' . $brand_suffix,
  ...
  'keyboardcode' => array (
    'title' => '键盘按键KeyCode码在线获取,KeyCode对照表' . $brand_suffix,
  ...
  'calculator' => array (
    'title' => '在线科学计算器,多功能计算器,进制角度计算' . $brand_suffix,
  ...
  'useragent' => array (
    'title' => '浏览器User-Agent大全,PC/移动端UA查询复制' . $brand_suffix,
  ...
  'ports' => array (
    'title' => 'TCP/UDP端口大全,常用端口号对照表查询' . $brand_suffix,
  ...
  'websocket' => array (
    'title' => 'Websocket在线测试工具,Websocket模拟请求调试' . $brand_suffix,
  ...
  'ip' => array (
    'title' => 'IP地址查询,IP归属地查询,域名解析查IP' . $brand_suffix,
  ...
  'linuxcmd' => array (
    'title' => 'Linux常用命令大全,Linux命令查询手册' . $brand_suffix,
  ...
  'shortcut' => array (
    'title' => '在线生成网址桌面快捷方式,一键创建网页快捷方式' . $brand_suffix,
  ...
  'xpath' => array (
    'title' => 'XPath在线测试工具,XPath提取HTML元素' . $brand_suffix,
  ...
  'regex' => array (
    'title' => '正则表达式在线测试工具,正则校验匹配' . $brand_suffix,
  ...
  'favicon' => array (
    'title' => 'ico图标在线制作,favicon图标生成转换' . $brand_suffix,
  ...
  'createmeta' => array (
    'title' => 'Meta标签在线生成工具,HTML5网页元信息生成' . $brand_suffix,
  ...
  'htaccess2nginx' => array (
    'title' => 'htaccess转nginx,Apache伪静态转Nginx规则' . $brand_suffix,
  ...
  'contenttype' => array (
    'title' => 'HTTP Content-Type对照表,MIME类型扩展名查询' . $brand_suffix,
  ...
  'androidmanifest' => array (
    'title' => 'Android权限大全,Manifest权限描述对照表' . $brand_suffix,
  ...
  'bootstrapicon' => array (
    'title' => 'Bootstrap字体图标大全,Glyphicons图标查询' . $brand_suffix,
  ...
  'caiji' => array (
    'title' => '文章在线采集工具,网页内容批量采集复制' . $brand_suffix,
    'keywords' => '文章采集,网页采集,内容采集,采集复制,在线采集器',
    'description' => '文章在线采集工具：输入网址一键采集网页文章标题与正文内容，解决网页无法复制的问题，采集结果可编辑整理，内容编辑与资料收集效率倍增。',
  ),

  'uuid' => array (
    'title' => 'UUID/GUID在线生成器,批量生成唯一标识' . $brand_suffix,
    'keywords' => 'UUID生成,GUID生成,唯一标识符,批量生成UUID,在线UUID',
    'description' => 'UUID/GUID 在线生成器：支持批量生成全局唯一标识符，可自定义生成数量与格式，开发测试、数据库主键、分布式系统标识生成必备。',
  ),

  'autoformat' => array (
    'title' => '文章自动排版工具,一键排版,论文排版' . $brand_suffix,
    'keywords' => '自动排版,一键排版,文章排版,论文排版,文本格式化',
    'description' => '文章自动排版工具：一键排版杂乱文本，自动分段、首行缩进、去除多余空行与空格，支持小说、论文等纯文本排版，让文章更整洁易读。',
  ),

  'dns' => array (
    'title' => '公共DNS服务器大全,阿里DNS/Google DNS/114DNS' . $brand_suffix,
  ...
  'subnetmask' => array (
    'title' => '子网掩码计算器,IP子网划分工具' . $brand_suffix,
  ...
  'calc' => array (
    'title' => '单位换算器,长度面积体积温度时间速度换算' . $brand_suffix,
  ...
  'format' => array (
    'title' => '代码格式化工具,14种语言在线美化排版' . $brand_suffix,
  ...
  'encrypt' => array (
    'title' => '加密解密工具大全,AES/DES/RC4/MD5/SHA在线加密' . $brand_suffix,
  ...
  'textconvert' => array (
    'title' => '文本转换工具,汉字转拼音/火星文/人民币大写' . $brand_suffix,
  ...
  'jsencrypt' => array (
    'title' => 'JS加密解密工具,JS混淆加密解密在线' . $brand_suffix,
