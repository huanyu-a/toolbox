...
return array (
  ...
  'currency' => array (
    'title' => '世界货币查询,实时汇率换算,货币名称符号大全',
    'keywords' => '世界货币,货币名称,货币符号,货币查询,货币进位制,实时汇率,汇率换算,美元,欧元,日元,英镑,港币,人民币',
    'description' => '世界货币查询与实时汇率换算：提供全球各国及地区货币名称、符号表示与进位制信息查询，支持美元、欧元、日元、英镑、港币、人民币等主流货币实时汇率在线换算，外贸、旅游、金融从业者快速查阅。',
  ),
