...
'encrypt' => 
  array (
    ...
    'textconvert' => array (
        'title' => '文本转换工具,汉字拼音/火星文/竖排翻转/驼峰下划线/人民币大写-在线工具箱',
        'keywords' => '文本转换,汉字转拼音,火星文转换,文字竖排,文字翻转,文字特效,全角半角转换,英文大小写转换,驼峰下划线转换,人民币大写',
        'description' => '文本转换在线工具合集，提供汉字转拼音及读音、火星文转换、文字竖排、文字翻转、彩色文字特效、全角半角互转、英文大小写转换、驼峰与下划线命名互转、人民币大写金额转换等功能（简繁转换请使用文章排版工具），全部在浏览器本地完成。',
    ),
    'texttool' => array (
        'title' => '文本工具,内容去重/字符串压缩/文本对比-在线工具箱',
        'keywords' => '文本工具,内容去重,去重复行,字符串压缩,去空格,文本对比,文本比较',
        'description' => '文本工具合集，提供按行内容去重、字符串压缩（去空格换行）、文本内容差异对比等功能（字数统计、文本替换请使用文章排版工具），全部在浏览器本地完成。',
    ),
    'convert' => array (
