<?php /*a:6:{s:44:"/app/application/index/view/index/runjs.html";i:1787036025;s:36:"/app/application/index/view/seo.html";i:1787024468;s:39:"/app/application/index/view/header.html";i:1787218864;s:36:"/app/application/index/view/nav.html";i:1786603123;s:39:"/app/application/index/view/footer.html";i:1787218004;s:37:"/app/application/index/view/link.html";i:1787217514;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" /><title><?php echo htmlentities(app('config')->get('web.runjs.title')); ?>-<?php echo htmlentities(app('config')->get('web.site.name')); ?></title><meta name="applicable-device" content="pc,mobile" /><meta http-equiv="Cache-Control" content="no-transform" /><meta http-equiv="Cache-Control" content="no-siteapp" /><meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.runjs.keywords')); ?>" /><meta name="description" content="<?php echo htmlentities(app('config')->get('web.runjs.description')); ?>" /><meta name="renderer" content="webkit" /><meta name="apple-mobile-web-app-capable" content="yes" /><link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-T510L8HTF9"></script><script>function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag("js",new Date),gtag("config","G-T510L8HTF9")</script><div class="container"><div class="tool-wrap"><div class="tool-card"><h2 class="tool-title"><span class="t-ico">▶️</span>运行Js/html/css</h2><p class="tool-desc">HTML/CSS/JS在线运行代码工具为您提供在在线执行Js代码工具,网页代码调试器,Html在线预览工具,可以把Html页面代码进行在线调试,在线预览 ,代码编辑器,</p><form id="form1" class="form-horizontal" method="post"><div class="form-group"><div class="col-sm-12"><textarea class="form-control" id="content" rows="15" placeholder="请把要调试的HTML代码粘贴到这里,支持在线运行JS"></textarea></div></div><div class="form-group"><div class="col-sm-12 text-center"><input class="btn btn-success" onclick="webdebug();" type="button" value="调试预览" /><input class="btn btn-default" onclick="content.select();" type="button" value="全选代码" /><span  class="btn btn-default" id="copyallcode" data-copy="#content">复制</span><input class="btn btn-default" type="button" onclick="content.value=''" value="清空" /></div></div></form></div></div></div><script src="/static/script/jquery-1.11.3.min.js" type="text/javascript"></script><script src="/static/script/bootstrap.min.js" type="text/javascript"></script><script type="text/javascript">function webdebug() { var win = window.open(); win.document.open(); win.document.write($("#content").val()); win.document.close() }</script><div class="container foot-history" id="foot-history">
    <div class="row">
