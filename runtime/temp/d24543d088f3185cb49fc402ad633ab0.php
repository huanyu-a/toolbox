<?php /*a:6:{s:44:"/app/application/index/view/index/picmd.html";i:1787650953;s:36:"/app/application/index/view/seo.html";i:1787024468;s:39:"/app/application/index/view/header.html";i:1787218864;s:36:"/app/application/index/view/nav.html";i:1786603123;s:39:"/app/application/index/view/footer.html";i:1787218004;s:37:"/app/application/index/view/link.html";i:1787217514;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" /><title><?php echo htmlentities(app('config')->get('web.picmd.title')); ?>-<?php echo htmlentities(app('config')->get('web.site.name')); ?></title><meta name="applicable-device" content="pc,mobile" /><meta http-equiv="Cache-Control" content="no-transform" /><meta http-equiv="Cache-Control" content="no-siteapp" /><meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.picmd.keywords')); ?>" /><meta name="description" content="<?php echo htmlentities(app('config')->get('web.picmd.description')); ?>" /><meta name="renderer" content="webkit" /><meta name="apple-mobile-web-app-capable" content="yes" /><link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-T510L8HTF9"></script><script>function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag("js",new Date),gtag("config","G-T510L8HTF9")</script><div class="container"><div class="tool-wrap"><div class="tool-card"><h2 class="tool-title"><span class="t-ico">🥧</span>Pi 命令速查</h2><p class="tool-desc">Pi AI CLI 命令在线速查：涵盖对话管理、记忆系统、个性化配置、插件管理等常用命令，点击命令即可复制。</p>   <div class="lt-search"><input type="search" id="linuxSearch" placeholder="输入命令或说明快速过滤" autocomplete="off" /></div><ul class="t-tabs"><li><button type="button" class="t-tab active" data-panel="p-basic">🚀 基础命令</button></li><li><button type="button" class="t-tab" data-panel="p-chat">💬 对话管理</button></li><li><button type="button" class="t-tab" data-panel="p-memory">🧠 记忆系统</button></li><li><button type="button" class="t-tab" data-panel="p-persona">👤 个性化</button></li><li><button type="button" class="t-tab" data-panel="p-config">⚙️ 配置管理</button></li><li><button type="button" class="t-tab" data-panel="p-trouble">🔧 故障排查</button></li></ul><div class="t-panel-wrap"><div class="lt-empty" id="linuxEmpty">未找到匹配的命令，请尝试其他关键词</div>

<div class="t-panel active" id="p-basic">
<h3 class="lt-sub">会话管理</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>启动交互会话</td><td>pi</td></tr>
<tr><td>单次执行</td><td>pi ask "你的问题"</td></tr>
<tr><td>继续会话</td><td>pi continue</td></tr>
<tr><td>列出历史</td><td>pi history</td></tr>
<tr><td>清除历史</td><td>pi history clear</td></tr>
<tr><td>查看状态</td><td>pi status</td></tr>
<tr><td>查看版本</td><td>pi --version</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-chat">
<h3 class="lt-sub">对话管理</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>新建对话</td><td>pi new</td></tr>
<tr><td>切换对话</td><td>pi switch &lt;conversation_id&gt;</td></tr>
<tr><td>列出对话</td><td>pi list</td></tr>
<tr><td>删除对话</td><td>pi delete &lt;conversation_id&gt;</td></tr>
<tr><td>导出对话</td><td>pi export &lt;conversation_id&gt; &gt; chat.md</td></tr>
<tr><td>搜索对话</td><td>pi search "关键词"</td></tr>
<tr><td>固定对话</td><td>pi pin &lt;conversation_id&gt;</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-memory">
<h3 class="lt-sub">记忆系统</h3>
<div class="hm-note">⚠️ 记忆系统让 Pi 记住你的偏好和重要信息</div>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>查看记忆</td><td>pi memory list</td></tr>
<tr><td>添加记忆</td><td>pi memory add "我喜欢用 TypeScript"</td></tr>
<tr><td>删除记忆</td><td>pi memory remove &lt;memory_id&gt;</td></tr>
<tr><td>搜索记忆</td><td>pi memory search "关键词"</td></tr>
<tr><td>更新记忆</td><td>pi memory update &lt;memory_id&gt; "新内容"</td></tr>
<tr><td>导出记忆</td><td>pi memory export &gt; memories.json</td></tr>
<tr><td>导入记忆</td><td>pi memory import memories.json</td></tr>
<tr><td>清除所有记忆</td><td>pi memory clear</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-persona">
<h3 class="lt-sub">个性化配置</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>设置名字</td><td>pi persona set name "小助手"</td></tr>
<tr><td>设置性格</td><td>pi persona set personality "友好、幽默"</td></tr>
<tr><td>设置专业领域</td><td>pi persona set expertise "前端开发、Node.js"</td></tr>
<tr><td>设置语言风格</td><td>pi persona set style "简洁、技术性强"</td></tr>
<tr><td>查看配置</td><td>pi persona show</td></tr>
<tr><td>重置配置</td><td>pi persona reset</td></tr>
<tr><td>导入配置</td><td>pi persona import persona.json</td></tr>
</tbody></table>
</div>
...
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>查看配置</td><td>pi config show</td></tr>
<tr><td>设置 API Key</td><td>pi config set api_key YOUR_KEY</td></tr>
<tr><td>设置模型</td><td>pi config set model gpt-4</td></tr>
<tr><td>设置温度</td><td>pi config set temperature 0.7</td></tr>
<tr><td>设置最大 token</td><td>pi config set max_tokens 4096</td></tr>
<tr><td>设置上下文长度</td><td>pi config set context_length 8192</td></tr>
<tr><td>重置配置</td><td>pi config reset</td></tr>
<tr><td>配置文件路径</td><td>~/.pi/config.yaml</td></tr>
</tbody></table>
</div>
...
<div class="hm-card"><h3>① 记忆保存失败</h3><div class="hm-desc"><b>根因</b>：记忆容量已满或格式错误 · <b>解法</b>：清理旧记忆或检查格式</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>检查容量</td><td>pi memory stats</td></tr><tr><td>清理旧记忆</td><td>pi memory prune --older-than 30d</td></tr></tbody></table></div>

<div class="hm-card"><h3>② 对话响应慢</h3><div class="hm-desc"><b>根因</b>：上下文过长或模型负载高 · <b>解法</b>：减少上下文或切换模型</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>压缩上下文</td><td>pi compress</td></tr><tr><td>切换模型</td><td>pi config set model gpt-3.5-turbo</td></tr></tbody></table></div>

<div class="hm-card"><h3>③ 个性化不生效</h3><div class="hm-desc"><b>根因</b>：配置未正确加载 · <b>解法</b>：重启会话并验证配置</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>验证配置</td><td>pi persona validate</td></tr><tr><td>重启会话</td><td>pi restart</td></tr></tbody></table></div>

<div class="hm-card"><h3>④ API 连接失败</h3><div class="hm-desc"><b>根因</b>：网络问题或 API Key 失效 · <b>解法</b>：检查网络并重新设置密钥</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>测试连接</td><td>pi ping</td></tr><tr><td>重置密钥</td><td>pi config set api_key NEW_KEY</td></tr></tbody></table></div>
</div>
