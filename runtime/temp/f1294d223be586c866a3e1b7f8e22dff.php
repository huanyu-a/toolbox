<?php /*a:6:{s:47:"/app/application/index/view/index/shortcut.html";i:1787024461;s:36:"/app/application/index/view/seo.html";i:1787024468;s:39:"/app/application/index/view/header.html";i:1787218864;s:36:"/app/application/index/view/nav.html";i:1786603123;s:39:"/app/application/index/view/footer.html";i:1787218004;s:37:"/app/application/index/view/link.html";i:1787217514;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" /><title><?php echo htmlentities(app('config')->get('web.shortcut.title')); ?>-<?php echo htmlentities(app('config')->get('web.site.name')); ?></title><meta name="applicable-device" content="pc,mobile" /><meta http-equiv="Cache-Control" content="no-transform" /><meta http-equiv="Cache-Control" content="no-siteapp" /><meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.shortcut.keywords')); ?>" /><meta name="description" content="<?php echo htmlentities(app('config')->get('web.shortcut.description')); ?>" /><meta name="renderer" content="webkit" /><meta name="apple-mobile-web-app-capable" content="yes" /><link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon" />
...
<div class="container"><div class="tool-wrap">
    <div class="tool-card">
        <h2 class="tool-title"><span class="t-ico">⚡</span>生成桌面快捷方式</h2>
        <p class="tool-desc">将指定网址一键生成 Windows 桌面快捷方式图标文件，无需安装任何软件。</p>
        <form action="" method="post" target="_blank" id="form" name="form">
            <div class="form-group">
                <label class="t-label" for="name">名称</label>
                <input type="text" class="t-input" id="name" name="name" value="<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>在线工具" style="max-width:420px" />
            </div>
            <div class="form-group">
                <label class="t-label" for="url">网址</label>
                <input type="text" id="url" name="url" class="t-input" value="http://<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>/" style="max-width:420px" />
            </div>
            <div class="tool-actions">
                <button type="button" name="generate" onclick="check()" class="t-btn">创建快捷方式并下载</button>
            </div>
        </form>
    </div>
</div></div>
