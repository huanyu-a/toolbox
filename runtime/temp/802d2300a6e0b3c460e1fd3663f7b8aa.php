<?php /*a:6:{s:46:"/app/application/index/view/index/opencmd.html";i:1787650766;s:36:"/app/application/index/view/seo.html";i:1787024468;s:39:"/app/application/index/view/header.html";i:1787218864;s:36:"/app/application/index/view/nav.html";i:1786603123;s:39:"/app/application/index/view/footer.html";i:1787218004;s:37:"/app/application/index/view/link.html";i:1787217514;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" /><title><?php echo htmlentities(app('config')->get('web.opencmd.title')); ?>-<?php echo htmlentities(app('config')->get('web.site.name')); ?></title><meta name="applicable-device" content="pc,mobile" /><meta http-equiv="Cache-Control" content="no-transform" /><meta http-equiv="Cache-Control" content="no-siteapp" /><meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.opencmd.keywords')); ?>" /><meta name="description" content="<?php echo htmlentities(app('config')->get('web.opencmd.description')); ?>" /><meta name="renderer" content="webkit" /><meta name="apple-mobile-web-app-capable" content="yes" /><link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-T510L8HTF9"></script><script>function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag("js",new Date),gtag("config","G-T510L8HTF9")</script><div class="container"><div class="tool-wrap"><div class="tool-card"><h2 class="tool-title"><span class="t-ico">🌐</span>Open Code 命令速查</h2><p class="tool-desc">Open Code CLI 命令在线速查：涵盖会话管理、模型切换、插件系统、配置管理等常用命令，点击命令即可复制。</p>   <div class="lt-search"><input type="search" id="linuxSearch" placeholder="输入命令或说明快速过滤" autocomplete="off" /></div><ul class="t-tabs"><li><button type="button" class="t-tab active" data-panel="p-basic">🚀 基础命令</button></li><li><button type="button" class="t-tab" data-panel="p-model">🧠 模型管理</button></li><li><button type="button" class="t-tab" data-panel="p-plugin">🔌 插件系统</button></li><li><button type="button" class="t-tab" data-panel="p-config">⚙️ 配置管理</button></li><li><button type="button" class="t-tab" data-panel="p-trouble">🔧 故障排查</button></li></ul><div class="t-panel-wrap"><div class="lt-empty" id="linuxEmpty">未找到匹配的命令，请尝试其他关键词</div>

<div class="t-panel active" id="p-basic">
<h3 class="lt-sub">会话管理</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>启动交互会话</td><td>open-code</td></tr>
<tr><td>单次执行</td><td>open-code run "你的提示词"</td></tr>
<tr><td>继续会话</td><td>open-code continue</td></tr>
<tr><td>列出历史</td><td>open-code history</td></tr>
<tr><td>清除历史</td><td>open-code clear</td></tr>
<tr><td>查看版本</td><td>open-code --version</td></tr>
<tr><td>显示帮助</td><td>open-code --help</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-model">
<h3 class="lt-sub">模型切换与管理</h3>
<div class="hm-note">⚠️ Open Code 支持多模型后端，可动态切换</div>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>查看当前模型</td><td>open-code model get</td></tr>
<tr><td>切换到 GPT-4</td><td>open-code model use gpt-4</td></tr>
<tr><td>切换到 Claude</td><td>open-code model use claude-3-opus</td></tr>
<tr><td>切换到本地模型</td><td>open-code model use llama2:70b</td></tr>
<tr><td>列出可用模型</td><td>open-code model list</td></tr>
<tr><td>设置默认模型</td><td>open-code model default gpt-4-turbo</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-plugin">
<h3 class="lt-sub">插件系统</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>安装插件</td><td>open-code plugin install plugin-name</td></tr>
<tr><td>卸载插件</td><td>open-code plugin uninstall plugin-name</td></tr>
<tr><td>列出已安装</td><td>open-code plugin list</td></tr>
<tr><td>搜索插件</td><td>open-code plugin search keyword</td></tr>
<tr><td>更新插件</td><td>open-code plugin update plugin-name</td></tr>
<tr><td>启用插件</td><td>open-code plugin enable plugin-name</td></tr>
<tr><td>禁用插件</td><td>open-code plugin disable plugin-name</td></tr>
</tbody></table>
</div>
...
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>查看配置</td><td>open-code config show</td></tr>
<tr><td>设置 API Key</td><td>open-code config set api_key YOUR_KEY</td></tr>
<tr><td>设置温度</td><td>open-code config set temperature 0.7</td></tr>
<tr><td>设置 max_tokens</td><td>open-code config set max_tokens 4096</td></tr>
<tr><td>重置配置</td><td>open-code config reset</td></tr>
<tr><td>编辑配置文件</td><td>open-code config edit</td></tr>
<tr><td>配置文件路径</td><td>~/.open-code/config.json</td></tr>
</tbody></table>
</div>
...
<div class="hm-card"><h3>① 命令未找到</h3><div class="hm-desc"><b>根因</b>：open-code 未安装或不在 PATH · <b>解法</b>：检查安装和环境变量</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>检查安装</td><td>which open-code</td></tr><tr><td>重新安装</td><td>npm install -g @open-code/cli</td></tr></tbody></table></div>

<div class="hm-card"><h3>② 模型连接失败</h3><div class="hm-desc"><b>根因</b>：API Key 无效或模型不可用 · <b>解法</b>：验证 API Key 并切换模型</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>测试连接</td><td>open-code model test</td></tr><tr><td>切换模型</td><td>open-code model use gpt-4</td></tr></tbody></table></div>

<div class="hm-card"><h3>③ 插件加载失败</h3><div class="hm-desc"><b>根因</b>：插件版本不兼容或依赖缺失 · <b>解法</b>：更新或重装插件</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>检查日志</td><td>open-code plugin logs plugin-name</td></tr><tr><td>重装插件</td><td>open-code plugin reinstall plugin-name</td></tr></tbody></table></div>

<div class="hm-card"><h3>④ 会话数据丢失</h3><div class="hm-desc"><b>根因</b>：缓存损坏或磁盘空间不足 · <b>解法</b>：清理缓存并重启</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>清理缓存</td><td>open-code cache clear</td></tr><tr><td>检查磁盘</td><td>df -h</td></tr></tbody></table></div>
</div>
