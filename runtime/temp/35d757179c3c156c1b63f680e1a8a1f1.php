<?php /*a:6:{s:47:"/app/application/index/view/index/codexcmd.html";i:1787650766;s:36:"/app/application/index/view/seo.html";i:1787024468;s:39:"/app/application/index/view/header.html";i:1787218864;s:36:"/app/application/index/view/nav.html";i:1786603123;s:39:"/app/application/index/view/footer.html";i:1787218004;s:37:"/app/application/index/view/link.html";i:1787217514;}*/ ?>
<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" /><title><?php echo htmlentities(app('config')->get('web.codexcmd.title')); ?>-<?php echo htmlentities(app('config')->get('web.site.name')); ?></title><meta name="applicable-device" content="pc,mobile" /><meta http-equiv="Cache-Control" content="no-transform" /><meta http-equiv="Cache-Control" content="no-siteapp" /><meta name="keywords" content="<?php echo htmlentities(app('config')->get('web.codexcmd.keywords')); ?>" /><meta name="description" content="<?php echo htmlentities(app('config')->get('web.codexcmd.description')); ?>" /><meta name="renderer" content="webkit" /><meta name="apple-mobile-web-app-capable" content="yes" /><link rel="icon" href="/favicon.ico" mce_href="/favicon.ico" type="image/x-icon" />
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-T510L8HTF9"></script><script>function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag("js",new Date),gtag("config","G-T510L8HTF9")</script><div class="container"><div class="tool-wrap"><div class="tool-card"><h2 class="tool-title"><span class="t-ico">📘</span>OpenAI Codex 命令速查</h2><p class="tool-desc">OpenAI Codex CLI 命令在线速查：涵盖代码生成、审查、测试、配置管理等常用命令，点击命令即可复制。</p>   <div class="lt-search"><input type="search" id="linuxSearch" placeholder="输入命令或说明快速过滤" autocomplete="off" /></div><ul class="t-tabs"><li><button type="button" class="t-tab active" data-panel="p-basic">🚀 基础命令</button></li><li><button type="button" class="t-tab" data-panel="p-code">💻 代码生成</button></li><li><button type="button" class="t-tab" data-panel="p-review">🔍 代码审查</button></li><li><button type="button" class="t-tab" data-panel="p-test">🧪 测试生成</button></li><li><button type="button" class="t-tab" data-panel="p-config">⚙️ 配置管理</button></li><li><button type="button" class="t-tab" data-panel="p-trouble">🔧 故障排查</button></li></ul><div class="t-panel-wrap"><div class="lt-empty" id="linuxEmpty">未找到匹配的命令，请尝试其他关键词</div>

<div class="t-panel active" id="p-basic">
<h3 class="lt-sub">会话管理</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>启动交互模式</td><td>codex</td></tr>
<tr><td>单次执行</td><td>codex exec "你的指令"</td></tr>
<tr><td>继续会话</td><td>codex resume</td></tr>
<tr><td>列出会话</td><td>codex sessions</td></tr>
<tr><td>清除会话</td><td>codex sessions clear</td></tr>
<tr><td>查看版本</td><td>codex --version</td></tr>
<tr><td>显示帮助</td><td>codex --help</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-code">
<h3 class="lt-sub">代码生成</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>生成函数</td><td>codex generate "实现快速排序函数"</td></tr>
<tr><td>生成类</td><td>codex generate "创建 User 类，包含 name 和 email"</td></tr>
<tr><td>生成 API</td><td>codex generate "创建 REST API 端点 /users"</td></tr>
<tr><td>生成数据库模型</td><td>codex generate "创建 Product 数据库模型"</td></tr>
<tr><td>生成前端组件</td><td>codex generate "创建 React 登录表单组件"</td></tr>
<tr><td>指定语言</td><td>codex generate --lang python "实现二分查找"</td></tr>
<tr><td>指定框架</td><td>codex generate --framework django "创建视图"</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-review">
<h3 class="lt-sub">代码审查</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>审查文件</td><td>codex review path/to/file.py</td></tr>
<tr><td>审查目录</td><td>codex review ./src/</td></tr>
<tr><td>审查 Git 差异</td><td>codex review --diff</td></tr>
<tr><td>检查代码质量</td><td>codex review --quality path/to/file.js</td></tr>
<tr><td>检查安全漏洞</td><td>codex review --security path/to/file.py</td></tr>
<tr><td>检查性能问题</td><td>codex review --performance path/to/file.go</td></tr>
<tr><td>生成审查报告</td><td>codex review --report ./src/ &gt; review.md</td></tr>
</tbody></table>
</div>

<div class="t-panel" id="p-test">
<h3 class="lt-sub">测试生成</h3>
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>生成单元测试</td><td>codex test path/to/function.py</td></tr>
<tr><td>生成集成测试</td><td>codex test --integration path/to/api.py</td></tr>
<tr><td>生成测试用例</td><td>codex test --cases "calculate_total 函数"</td></tr>
<tr><td>指定测试框架</td><td>codex test --framework pytest path/to/file.py</td></tr>
<tr><td>生成 mock</td><td>codex test --mock path/to/service.py</td></tr>
<tr><td>覆盖率分析</td><td>codex test --coverage ./tests/</td></tr>
</tbody></table>
</div>
...
<table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr>
<tr><td>查看配置</td><td>codex config show</td></tr>
<tr><td>设置 API Key</td><td>export OPENAI_API_KEY=your_key</td></tr>
<tr><td>设置模型</td><td>codex config set model gpt-4-turbo</td></tr>
<tr><td>设置温度</td><td>codex config set temperature 0.3</td></tr>
<tr><td>设置输出格式</td><td>codex config set output_format json</td></tr>
<tr><td>重置配置</td><td>codex config reset</td></tr>
<tr><td>配置文件路径</td><td>~/.codex/config.yaml</td></tr>
</tbody></table>
</div>
...
<div class="hm-card"><h3>① API 速率限制</h3><div class="hm-desc"><b>根因</b>：请求频率过高 · <b>解法</b>：等待或升级 API 套餐</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>查看限额</td><td>codex quota</td></tr><tr><td>降低频率</td><td>codex config set rate_limit 10</td></tr></tbody></table></div>

<div class="hm-card"><h3>② 生成代码不完整</h3><div class="hm-desc"><b>根因</b>：max_tokens 设置过低 · <b>解法</b>：增加 token 限制</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>增加限制</td><td>codex config set max_tokens 8192</td></tr></tbody></table></div>

<div class="hm-card"><h3>③ 代码质量不佳</h3><div class="hm-desc"><b>根因</b>：提示词不够清晰 · <b>解法</b>：提供更详细的上下文</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>添加上下文</td><td>codex generate --context "使用 TypeScript + Express"</td></tr></tbody></table></div>

<div class="hm-card"><h3>④ 网络连接超时</h3><div class="hm-desc"><b>根因</b>：网络不稳定或防火墙拦截 · <b>解法</b>：检查网络或配置代理</div><table class="lt"><tbody><tr><th>操作</th><th>命令</th></tr><tr><td>测试连接</td><td>curl https://api.openai.com</td></tr><tr><td>设置代理</td><td>export HTTPS_PROXY=http://proxy:port</td></tr></tbody></table></div>
</div>
