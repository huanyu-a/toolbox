...
class Index extends Controller
{
    public function index()
    {
        ...
        // 当前工具信息（面包屑 + 导航高亮 + SEO）
        $act = input('act', 'index');
        // 工具合并 301 映射（旧 URL → 新主页面，SEO 权重转移）
        $mergeMap = array(
            'urlencode' => '/urlcode/',
            'guid' => '/uuid/',
            'jsonlrview' => '/json/',
            ...
            'htmltable' => '/html2js/',
            'htmlfromcsv' => '/html2js/',
            'aesencrypt' => '/deencrypt/',
            'desencrypt' => '/deencrypt/',
            'tripledes' => '/deencrypt/',
            'rc4encrypt' => '/deencrypt/',
            'rabbitencrypt' => '/deencrypt/',
            'md5' => '/allencrypt/',
            'shaencrypt' => '/allencrypt/',
            'navtiveunicode' => '/unicode/',
            'asciicode' => '/ascii/',
            'htmlescapechar' => '/htmlescape/',
            'webstatus' => '/pagecode/',
            'ip2long' => '/ip/',
            'requestmethod' => '/httpheader/',
            'tiaoseban' => '/hexrgb/',
            'calcarea' => '/calc/',
            'calclength' => '/calc/',
            'calcvolume' => '/calc/',
            'calctemperature' => '/calc/',
            'calctime' => '/calc/',
            'calcspeed' => '/calc/',
            'calcpressure' => '/calc/',
            'calcpower' => '/calc/',
            ...
            'regexdso' => '/regex/',
            'regexsucha' => '/regex/',
            'keyboardtest' => '/keyboardcode/',
            'androidkeycode' => '/keyboardcode/',
            'password' => '/random/',
            'worldtime' => '/unixtime/',
            'shizhong' => '/unixtime/',
            'chameta' => '/createmeta/',
        );
        if (isset($mergeMap[$act])) {
            return redirect($mergeMap[$act], 301);
        }
        $data['act'] = $act;
